...
- **Fecha**: 2025-07-23T22:51:41.494698
...
**Resultados**:
- CON CODE_RETRIEVAL_QUERY: Error - {code: Neo.ClientError.Statement.ArgumentError} {message: Invalid input for 'vector.similarity.cosine()': The supplied vectors do not have the same number of dimensions.}
- SIN CODE_RETRIEVAL_QUERY: Error - {code: Neo.ClientError.Statement.ArgumentError} {message: Invalid input for 'vector.similarity.cosine()': The supplied vectors do not have the same number of dimensions.}
...
*Generado el 2025-07-23T22:51:41.494698*
